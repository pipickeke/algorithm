...
public class Combination_Sum_IV_2 {
    ...
    private int dfs_2(int target, int[] nums, int[] memo){
        if (target == 0){
            return 1;
        }
        if (memo[target] != -1){
    ...
    private int combinationSum4_3(int[] nums, int target){
