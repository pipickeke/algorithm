...
public class Number_of_Digit_One_3 {


    public static void main(String[] args) {
        Number_of_Digit_One_3 bean = new Number_of_Digit_One_3();
        System.out.println(bean.countDigitOne(13));
    }
    ...
    private int dfs(int index, int cnt, boolean islimit, int[][] memo, char[] strs){
        ...
        for (int d = 0; d <= up; d++) {
            res += dfs(index+1, cnt + (d == 1 ? 1 : 0), islimit && d == up, memo, strs);
        }
